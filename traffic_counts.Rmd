...
In my Bayesian model, I run a posterior predictive check to compare thew simulated values to the observed values from Open AQ.

I compute 95% credible intervals for each parameter described above. I create a faceted
density plot of the posterior distributions for each parameter, with the 95% credible intervals marked by the red dashed lines.  
...
Aggregating data ot match PM2.5 hourly averages
```{r}
